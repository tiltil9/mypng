...
set_min_library saed90nm_io_max_fc_pg.db    -min_ver saed90nm_io_min_fc_pg.db

#   design
set top_name            "png_top_with_pad"
...
set verilog_file        "$rtl_path/$top_name.v          \
                         $dc_netlist_path/png_top.dc.v  "
...
# # power nwtwork synthesis
# # power rings
# set_fp_rail_constraints  -set_ring                 \
#                          -nets  "VDD VSS"          \
#                          -horizontal_ring_layer M9 \
#                          -vertical_ring_layer   M8 \
#                          -ring_min_width 3         \
#                          -ring_max_width 5         \
...
create_rectangular_rings  -nets   {VDD VSS}                        \
                          -around specified                        \
                          -cells  {png_top/fifo_flt/ram_90nm             \
                                   png_top/filter_top/fifo_1/ram_90nm    \
                                   png_top/filter_top/fifo_0/ram_90nm }  \
...
#                                    png_top/filter_top/fifo_1/ram_90nm    \
#                                    png_top/filter_top/fifo_0/ram_90nm }  \
#                           -left_offset   0.5 -left_segment_layer   M4 -left_segment_width   1.5 \
#                           -right_offset  0.5 -right_segment_layer  M4 -right_segment_width  1.5 \
#                           -bottom_offset 0.5 -bottom_segment_layer M5 -bottom_segment_width 1.5 \
#                           -top_offset    0.5 -top_segment_layer    M5 -top_segment_width    1.5

# create_fp_virtual_pad -nets VDD -point {0   0  }
# create_fp_virtual_pad -nets VSS -point {500 500}
...
set_dont_touch_placement {png_top/fifo_flt/ram_90nm          \
                          png_top/filter_top/fifo_1/ram_90nm \
                          png_top/filter_top/fifo_0/ram_90nm }
...
route_opt
# psynopt -in_place_size_only -on_route
route_zrt_eco
report_constraints
verify_zrt_route
